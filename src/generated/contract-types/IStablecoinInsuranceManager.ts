...
export interface IStablecoinInsuranceManagerInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "activatePolicy"
      | "cancelPolicy"
...
export interface IStablecoinInsuranceManager extends BaseContract {
  connect(runner?: ContractRunner | null): BaseContract;
  attach(addressOrName: AddressLike): this;
  deployed(): Promise<this>;

  interface: IStablecoinInsuranceManagerInterface;
