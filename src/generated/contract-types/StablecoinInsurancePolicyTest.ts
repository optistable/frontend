...
export interface StablecoinInsurancePolicyTestInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "IS_TEST"
      | "excludeArtifacts"
  ...
  encodeFunctionData(
    functionFragment: "testIncrement",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "testSetNumber",
    values: [BigNumberish]
  ): string;
...
export interface StablecoinInsurancePolicyTest extends BaseContract {
  connect(runner?: ContractRunner | null): BaseContract;
  attach(addressOrName: AddressLike): this;
  deployed(): Promise<this>;

  interface: StablecoinInsurancePolicyTestInterface;
  ...
  testIncrement: TypedContractMethod<[], [void], "nonpayable">;

  testSetNumber: TypedContractMethod<[x: BigNumberish], [void], "nonpayable">;
  ...
  getFunction(
    nameOrSignature: "testIncrement"
  ): TypedContractMethod<[], [void], "nonpayable">;
  getFunction(
    nameOrSignature: "testSetNumber"
