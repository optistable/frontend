...
export interface MainDemoConsumerBaseInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "aggregateValues"
...
export interface MainDemoConsumerBase extends BaseContract {
  connect(runner?: ContractRunner | null): BaseContract;
  attach(addressOrName: AddressLike): this;
  deployed(): Promise<this>;

  interface: MainDemoConsumerBaseInterface;
