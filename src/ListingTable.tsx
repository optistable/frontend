...
// import {PolicyManagerContext} from "./FunctionsManagerProvider";
//
//
...
//     const {policyManager, functionsBillingRegistry} = useContext(PolicyManagerContext);
//     useEffect(() => {
...
//                             <TableCell width={"55%"}><Typography>Policy ID</Typography></TableCell>}
//                         {columns.find(f => f === "author") &&
//                             <TableCell width={"10%"}><Typography>Insured Token</Typography></TableCell>}
//                         {columns.find(f => f === "category") &&
//                             <TableCell width={"10%"}><Typography>Current Price</Typography></TableCell>}
//                         {columns.find(f => f === "fee") &&
//                             <TableCell width={"10%"}><Typography>Depegged</Typography></TableCell>}
//                         {columns.find(f => f === "created") &&
//                             <TableCell width={"10%"}><Typography>Claimable in...</Typography></TableCell>}
//                         {columns.find(f => f === "actions") &&
//                             <TableCell width={"5%"}><Typography>Expires on...</Typography></TableCell>}
//                     </TableRow>
//                 </TableHead>
//                 <TableBody>
